  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex h-[calc(100vh-140px)]">
        ...
        {/* Left Sidebar - Deals/Tasks/Notes Widgets */}
        ...
        <div className="flex-1 bg-gray-900 h-full overflow-hidden">
          ...
          <div className="bg-gray-800 border-b border-gray-700 p-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <select className="bg-gray-600 text-white text-sm px-3 py-2 rounded border border-gray-500">
                ...
                <div key={activity.id} className="bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-gray-600 transition-colors">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="text-white font-medium text-base mb-1">{activity.title}</div>
                          ...
                          {activity.status && (
                            <div className="inline-block bg-green-900 text-green-300 text-xs px-3 py-1 rounded-full">
                              {activity.status}
                            </div>
                          )}
                        </div>
