    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex">
        ...
        <div className="w-80 bg-gray-800 border-r border-gray-700 h-screen overflow-y-auto">
          ...
          {/* Moved Widgets from Right Sidebar */}
          <div className="space-y-1 mt-1">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl border border-gray-700">
              <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl shadow-inner border border-gray-600">
                ...
                {contactsExpanded && (
                  <div className="p-2 bg-gradient-to-b from-gray-800 to-gray-900 rounded-b-xl max-h-48 overflow-y-auto">
                    <div className="space-y-2">
                      {contacts.map((contact) => (
                        <div key={contact.id} className="bg-gradient-to-r from-gray-700 to-gray-800 p-3 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all duration-200 shadow-lg border border-gray-600 hover:shadow-xl hover:border-blue-500/30">
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-lg">
                              {contact.initials}
                            </div>
                ...
                {dealsExpanded && (
                  <div className="p-2 bg-gradient-to-b from-gray-800 to-gray-900 rounded-b-xl max-h-48 overflow-y-auto">
                    <div className="text-center py-6">
                      ...
                      <button className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl" data-testid="button-add-deal">
                        + Create Deal
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="p-2 bg-gradient-to-b from-gray-800 to-gray-900 rounded-b-xl max-h-48 overflow-y-auto">
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={task.id} className="bg-gradient-to-r from-gray-700 to-gray-800 p-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all duration-200 shadow-lg border border-gray-600 hover:shadow-xl hover:border-purple-500/30">
                          <div className="flex items-start justify-between">
                            <div className="flex items-start space-x-2">
                              <div className={`w-2 h-2 rounded-full mt-2 ${task.status === 'completed' ? 'bg-green-500' : 'bg-yellow-500'} shadow-lg`}></div>
                              <div className="flex-1">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl border border-gray-700">
              <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl shadow-inner border border-gray-600">
                ...
                {notesExpanded && (
                  <div className="p-2 bg-gradient-to-b from-gray-800 to-gray-900 rounded-b-xl max-h-48 overflow-y-auto">
                    <div className="text-center py-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-orange-600 to-orange-800 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg">
                        <FileText className="h-6 w-6 text-white" />
                      </div>
                      <div className="text-gray-300 text-sm mb-2 font-medium">No notes yet</div>
                      <div className="text-gray-400 text-xs mb-3">
                        Start documenting important information about this company
                      </div>
                      <button className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-500 hover:to-orange-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl" data-testid="button-add-note">
                        + Add Note
                      </button>
                    </div>
                  </div>
