            ...
            <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl shadow-inner border border-gray-600">
              ...
              <div className="p-4 border-b border-gray-600 bg-gradient-to-r from-gray-700 via-gray-800 to-gray-700 rounded-t-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <h3 className="font-semibold text-white text-lg">Company Insights</h3>
              ...
              {insightsExpanded && (
                <div className="p-4 bg-gradient-to-b from-gray-800 to-gray-900 rounded-b-xl">
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center space-x-1 px-2 py-1 rounded-lg transition-all duration-200 border text-sm ${
                        ...
                        >
                          <IconComponent className={`h-3 w-3 ${activeInsightTab === tab.key ? 'text-white' : tab.color}`} />
                  ...
                  {/* Enhanced Content Sections - Compact Version */}
                  <div className="bg-gradient-to-r from-gray-700 to-gray-800 rounded-xl p-3 border border-gray-600">
                    {/* Score Content */}
                    {activeInsightTab === 'score' && (
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <div className="text-2xl font-bold text-white">87<span className="text-sm text-gray-400">/100</span></div>
                            <div className="space-y-1">
                              <div className="text-sm text-green-400 bg-green-900/50 px-2 py-1 rounded border border-green-700">
                                Excellent Prospect
                              </div>
                              <div className="text-xs text-gray-300">High conversion potential</div>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-1 gap-2">
                          <div className="bg-gray-800 p-3 rounded-lg border border-gray-600">
                            <h4 className="text-gray-400 text-xs mb-2">Growth Indicators</h4>
                          ...
                          {[
                            ...
                            <div key={index} className="bg-gray-800 p-2 rounded border border-gray-600">
                              <div className="flex items-start justify-between mb-1">
                                <h5 className="text-white font-medium text-xs leading-tight">{article.title}</h5>
                                <span className={`px-1 py-0.5 rounded text-xs ${
                                  article.sentiment === 'positive' ? 'bg-green-900/50 text-green-300' : 'bg-gray-600 text-gray-300'
                                }`}>
                                  +
                                </span>
                              </div>
                    ...
                    {/* Other tabs content - compact versions */}
                    {activeInsightTab === 'technologies' && (
                      <div className="space-y-2">
                        <h4 className="text-white font-medium text-sm">Technology Stack</h4>
                        <div className="grid grid-cols-1 gap-2">
                          <div className="bg-gray-800 p-2 rounded border border-gray-600">
                            <h5 className="text-blue-400 font-medium mb-1 text-xs">Frontend</h5>
                            <div className="flex flex-wrap gap-1">
                              {['React', 'TypeScript', 'Tailwind'].map((tech, i) => (
                                <span key={i} className="text-gray-300 text-xs bg-gray-700 px-1 py-0.5 rounded">{tech}</span>
                              ))}
                            </div>
                          </div>
                        </div>
                    ...
                    {activeInsightTab === 'funding' && (
                      <div className="space-y-2">
                        <h4 className="text-white font-medium text-sm">Funding History</h4>
                        <div className="bg-gray-800 p-2 rounded border border-gray-600">
                          <div className="flex items-center justify-between mb-1">
                            <span className="bg-green-600 text-white px-2 py-0.5 rounded text-xs">Series B</span>
                            <span className="text-white font-bold text-sm">$25M</span>
                          </div>
                          <div className="text-gray-300 text-xs">Valuation: <span className="text-green-400">$150M</span></div>
                        </div>
                      </div>
                    )}
                    ...
                    {activeInsightTab === 'job-postings' && (
                      <div className="space-y-2">
                        <h4 className="text-white font-medium text-sm">Active Jobs</h4>
                    ...
                    {activeInsightTab === 'employee-trends' && (
                      <div className="space-y-2">
                        <h4 className="text-white font-medium text-sm">Employee Growth</h4>
                        <div className="bg-gray-800 p-2 rounded border border-gray-600">
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300 text-xs">Growth Rate</span>
                    ...
                    {activeInsightTab === 'website-visitors' && (
                      <div className="space-y-2">
                        <h4 className="text-white font-medium text-sm">Website Traffic</h4>
                        <div className="bg-gray-800 p-2 rounded border border-gray-600">
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300 text-xs">Monthly Visitors</span>
                            <span className="text-pink-400 font-bold">2.3M</span>
                          </div>
                        </div>
                      </div>
                    )}
