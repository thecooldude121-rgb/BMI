        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden card-hover">
          <div className="flex">
            ...
            <div className="flex-shrink-0 bg-white border-r border-gray-200" style={{ width: '320px' }}>
              ...
              {/* Frozen Content */}
              <div ref={frozenScrollRef} className="overflow-y-auto scroll-smooth scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-500" style={{ maxHeight: 'calc(100vh - 350px)' }}>
            ...
            <div className="flex-1 overflow-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-500 scroll-smooth">
              {/* Scrollable Header */}
              ...
              {/* Scrollable Content */}
              <div ref={scrollableScrollRef} className="overflow-y-auto scroll-smooth scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-500" style={{ maxHeight: 'calc(100vh - 350px)' }}>
                <div className="divide-y divide-gray-200">
                  {paginatedCompanies.map((company, index) => (
