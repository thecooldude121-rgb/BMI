...
async function seedDealSpecificActivities(
  ...
  // Insert all deal-specific activities with better error handling
  try {
    ...
    console.log(`⚠️ Some activities may already exist, skipping duplicates`);
  }
}
    ...
    if (existingActivities.length < 8) {
      const activitiesToCreate = [
        ...
        // Product Demo Phase
        {
          ...
          type: "demo" as const,
          status: deal.stage === 'qualification' ? "planned" as const : "completed" as const,
        ...
        // Proposal Phase
        {
          ...
          type: "task" as const,
          status: deal.stage === 'qualification' || deal.stage === 'discovery' ? "planned" as const : "completed" as const,
          priority: "high" as const,
        ...
        // Contract Phase
        {
          ...
          type: "call" as const,
          status: deal.stage === 'closed-won' ? "completed" as const : "planned" as const,
          priority: "critical" as const,
          description: `Contract terms discussion for ${deal.name}`,
        ...
        // Implementation Planning
        {
          ...
          type: "task" as const,
          status: deal.stage === 'closed-won' ? "planned" as const : "planned" as const,
          priority: deal.stage === 'closed-won' ? "critical" as const : "medium" as const,
        ...
        // Follow-up Activity
        {
          ...
          status: deal.stage === 'closed-lost' ? "cancelled" as const : "planned" as const,
          priority: "medium" as const,
...
export async function seedDatabase() {
  try {
    ...
    // Create additional comprehensive activities for all deals (including existing ones with few activities)
    await createComprehensiveActivitiesForAllDeals();
